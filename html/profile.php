...
<div class="container-fluid bg-white">
    ...
    <a href="searchid.php"><button class="btn-dark p-2 mr-4 shadow">Search</button></a>
    <a href="editBook.php?edit=<?php echo $token; ?>"><button class="btn-dark p-2 px-4 mr-4 shadow">Edit</button></a>
        <a href="signout.php"><button class="btn-dark p-2 mr-4 shadow">Sign Out</button></a>
    </div>
</div>
   <!--ABOUT STARTS HERE-->
